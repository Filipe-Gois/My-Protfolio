window.VLibras = (function (t) {
    ...
    function c(t, e) {
      for (var n = {}, i = [], o = 0; o < t.length; o++) {
        ...
        -1 !== d
          ...
          : a.push({ identifier: u, updater: g(p, e), references: 1 }),
          i.push(u);
      }
      return i;
    }
  ...
  function (t, e, n) {
    ...
    const i = () => v(document.body, "vpw-fullscreen"),
      ...
      L = (t = !0) => {
        t
          ? u("[vp-controls] .vpw-controls-button").setAttribute("disabled", !0)
          : u("[vp-controls] .vpw-controls-button").removeAttribute("disabled");
      },
      T = (t, e, n) => {
      ...
      window.onload && (y = window.onload),
        (window.onload = () => {
          ...
          m.load(r("[vw-access-button]"), this.element),
            ...
            window.addEventListener("vp-widget-wrapper-set-side", (t) => {
              ...
              (this.element = u()),
                (this.element.style.left = e.includes("L")
                  ...
                  ? "50%"
                  : "initial"),
                (this.element.style.right = e.includes("R") ? "0" : "initial"),
                (this.element.style.top = e.includes("T")
                  ? "0"
                  : ["L", "R"].includes(e)
                  ? "50%"
                  : "initial"),
                (this.element.style.bottom = e.includes("B") ? "0" : "initial"),
            ...
            p.includes(w) &&
              window.dispatchEvent(
                new CustomEvent("vp-widget-wrapper-set-side", { detail: w })
              );
        });
    };
  },
      ...
      (this.element = t),
        ...
        this.element.addEventListener("click", async () => {
          ...
          const { Plugin: t } = await n.e(0).then(n.bind(null, 17)),
            { loadTextCaptureScript: e } = await n.e(0).then(n.bind(null, 18));
